...
const ServerMessage$json = const {
  ...
  '2': const [
    ...
    const {'1': 'send_latest_message', '3': 10, '4': 1, '5': 11, '6': '.main.ServerMessage.SendLatestMessage', '9': 0, '10': 'sendLatestMessage'},
  ],
  '3': const [ServerMessage_ConfirmKeyExchange$json, ServerMessage_ConfirmLogIn$json, ServerMessage_AccountRegistrationResult$json, ServerMessage_AccountRegistrationCodeResult$json, ServerMessage_SendUserList$json, ServerMessage_SendPublicKey$json, ServerMessage_SendChatList$json, ServerMessage_SendChatSharedKey$json, ServerMessage_ChatMessage$json, ServerMessage_SendMessages$json, ServerMessage_SendLatestMessage$json],
  '8': const [
    const {'1': 'variant'},
  ],
};
...
@$core.Deprecated('Use serverMessageDescriptor instead')
const ServerMessage_ChatMessage$json = const {
  '1': 'ChatMessage',
  '2': const [
    const {'1': 'id', '3': 1, '4': 1, '5': 13, '10': 'id'},
...
const ServerMessage_SendMessages$json = const {
  '1': 'SendMessages',
  '2': const [
    const {'1': 'messages', '3': 1, '4': 3, '5': 11, '6': '.main.ServerMessage.ChatMessage', '10': 'messages'},
  ],
};

@$core.Deprecated('Use serverMessageDescriptor instead')
const ServerMessage_SendLatestMessage$json = const {
  '1': 'SendLatestMessage',
  '2': const [
    const {'1': 'message', '3': 1, '4': 1, '5': 11, '6': '.main.ServerMessage.ChatMessage', '10': 'message'},
  ],
};

/// Descriptor for `ServerMessage`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List serverMessageDescriptor = $convert.base64Decode('');
